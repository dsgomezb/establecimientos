...
-- Tiempo de generación: 02-07-2020 a las 13:53:52
...
CREATE TABLE IF NOT EXISTS `establecimiento` (
  ...
  `open` smallint(1) DEFAULT '0' COMMENT '1: abierto, 0: cerrado',
  `costo_envio` float DEFAULT NULL,
  `acepta_pago_online` smallint(1) DEFAULT '0' COMMENT '1: si, 0: no',
...
INSERT INTO `establecimiento` (`id_establecimiento`, `name_establecimiento`, `direccion_establecimiento`, `latitud`, `longitud`, `direccion_completa`, `telefono_establecimiento`, `id_muni`, `status_establecimiento`, `open`, `costo_envio`, `acepta_pago_online`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Estanquillo 11', 'calle 47A 1', NULL, NULL, NULL, '88890987', 6, 1, 1, NULL, 0, '2019-12-17 15:12:25', NULL, NULL),
(2, 'Estanquillo Los amigos', 'calle 47A 21', 5.05104, -75.5004, NULL, '888909871', 1, 1, 0, NULL, 0, '2019-12-17 15:10:52', NULL, NULL),
(3, 'Zona Refrescante', 'Zona Refrescante, El Cable, Cra. 23 #No. 64-17, Manizales, Caldas', 5.05729, -75.4865, NULL, '(036)8810588', 338, 1, 0, NULL, 0, '2020-01-23 02:39:18', NULL, NULL),
(4, 'tienda mixta', 'calle 37A-91', NULL, NULL, NULL, '888900', 338, 1, 0, NULL, 0, '2019-12-23 19:06:15', NULL, NULL),
(15, 'casa', 'calle 7a Manizales', 5.07542, -75.528, 'Cl. 7a, Manizales, Caldas, Colombia', '8880678', 338, 1, 1, NULL, 0, '2020-01-31 04:06:33', NULL, NULL),
(12, 'Estanquillo Balu', 'Calle 67 #31-09 Manizales', 5.05263, -75.4951, NULL, '8890078', 338, 1, 0, NULL, 0, '2020-01-31 03:08:09', NULL, NULL),
(16, 'Estanquillo frances', 'Calle 26 #31-09 Manizales', 5.05263, -75.4951, NULL, '8890078', 338, 1, 0, NULL, 0, '2020-01-31 03:08:09', NULL, NULL),
(17, 'tienda y licores ausez', 'carrera 23 45', NULL, NULL, NULL, '888900', 338, 1, 0, NULL, 0, '2019-12-23 19:06:15', NULL, NULL);
...
(86, 3, 1, 3, 'Aguardiante', 'Blanco', 36000, 8, 38880, '1000002', 'archivos\\imagen1000002-1578012001154.png', 3, '2020-01-03 00:40:01', NULL, '2020-01-03 00:39:25'),
(84, 3, 3, 3, 'Ron Viejo de caldas', 'Amarillo', 34000, 2, 34680, '130009', 'archivos\\imagen130009-1577463341333.png', 3, '2019-12-27 16:15:41', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `schedule` (
  ...
  `description_schedule` varchar(500) DEFAULT NULL,
  ...
  KEY `id_establecimiento` (`id_establecimiento`),
  KEY `status_schedule` (`status_schedule`)
...
INSERT INTO `schedule` (`id_schedule`, `id_establecimiento`, `name_schedule`, `description_schedule`, `status_schedule`, `created_at`, `updated_at`, `deleted_at`) VALUES
(2, 2, 'Horario Dia', 'Este es el horario de día del establecimiento', 4, '2020-02-21 03:39:54', NULL, NULL),
(3, 2, 'Horario cierre', 'Horario 2', 3, '2020-03-01 23:25:30', NULL, NULL),
(4, 2, 'Horario intermedio', 'este es un horario', 4, '2020-03-02 16:17:43', NULL, NULL),
(5, 15, 'Horario prueba edicion actualziado 2', 'Este es el horario actualizado', 3, '2020-03-07 03:42:10', '2020-03-07 05:28:53', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `schedule_detail`
--

DROP TABLE IF EXISTS `schedule_detail`;
CREATE TABLE IF NOT EXISTS `schedule_detail` (
  `id_schedule_detail` int(11) NOT NULL AUTO_INCREMENT,
  `id_schedule` int(11) NOT NULL,
  `start_hour_monday` time DEFAULT NULL,
  `end_hour_monday` time DEFAULT NULL,
  `start_hour_tuesday` time DEFAULT NULL,
  `end_hour_tuesday` time DEFAULT NULL,
  `start_hour_wednesday` time DEFAULT NULL,
  `end_hour_wednesday` time DEFAULT NULL,
  `start_hour_thursday` time DEFAULT NULL,
  `end_hour_thursday` time DEFAULT NULL,
  `start_hour_friday` time DEFAULT NULL,
  `end_hour_friday` time DEFAULT NULL,
  `start_hour_saturday` time DEFAULT NULL,
  `end_hour_saturday` time DEFAULT NULL,
  `start_hour_sunday` time DEFAULT NULL,
  `end_hour_sunday` time DEFAULT NULL,
  PRIMARY KEY (`id_schedule_detail`),
  KEY `id_schedule` (`id_schedule`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `schedule_detail`
--

INSERT INTO `schedule_detail` (`id_schedule_detail`, `id_schedule`, `start_hour_monday`, `end_hour_monday`, `start_hour_tuesday`, `end_hour_tuesday`, `start_hour_wednesday`, `end_hour_wednesday`, `start_hour_thursday`, `end_hour_thursday`, `start_hour_friday`, `end_hour_friday`, `start_hour_saturday`, `end_hour_saturday`, `start_hour_sunday`, `end_hour_sunday`) VALUES
(1, 2, '07:00:00', '07:30:00', '08:00:00', '08:30:00', '09:00:00', '09:30:00', '10:00:00', '10:30:00', '11:00:00', '11:30:00', '12:00:00', '12:30:00', '01:00:00', '01:30:00'),
(2, 3, '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00', '08:00:00'),
(3, 4, '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00', '05:00:00'),
(4, 5, '01:03:00', '02:03:00', '05:03:00', '06:03:00', '09:03:00', '10:03:00', '13:03:00', '14:03:00', '03:03:00', '04:03:00', '07:03:00', '08:03:00', '11:03:00', '12:03:00');
...
(70, 46, 'casa daniel', 'Bajando por la angosta', 'calle 37A 32 A', 338, 0),
(72, 46, 'casa 2', 'Por la fiscalia', 'cra 24 20 33', 338, 1);
